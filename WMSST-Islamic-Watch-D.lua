...
var_ie_monthnames = {"Muharram", "Safar", "First Rabi", "Second Rabi", "First Jumada", "Second Jumada", "Rajab",
                     "Sha'ban", "Ramadan", "Shawwal", "Zu al-Qada", "Zu al-Hijjah"}

var_en_monthnames = {"Jan", "Feb ", "Mar", "Apr", "May", "June", "July", "Aug", "Sept", "Oct", "Nov", "Dec"}

var_en_daynames = {"Sun", "Mon", "Tues", "Wed", "Thurs", "Fri", "Sat"}

var_ia_monthnames = {"محرّم", "صفر", "ربيع الأوّل", "ربيع الثاني",
                     "جمادى الأولى", "جمادى الثانية", "رجب", "شعبان", "رمضان",
                     "شوّال", "ذو القعدة", "ذو الحجّة"}

var_ar_monthnames = {"يناير", "فبراير", "مارس", "أبريل", "مايو", "يونيو", "يوليو",
                     "أغسطس", "سبتمبر", "أكتوبر", "نوفمبر", "ديسمبر"}

var_ar_daynames = {"الأحد", "الإثنين", "الثلاثاء", "الأربعاء", "الخميس",
                   "الجمعة", "السبت"}
...
function isl_ly(y)
    local yy = y % 30
    return
        yy == 2 or yy == 5 or yy == 7 or yy == 10 or yy == 13 or yy == 16 or yy == 18 or yy == 21 or yy == 24 or yy ==
            26 or yy == 29
end
...
function isl_last_day(m, y)
    if m == 1 or m == 3 or m == 5 or m == 7 or m == 9 or m == 11 then
        return 30
    elseif m == 2 or m == 4 or m == 6 or m == 8 or m == 10 then
        return 29
    elseif isl_ly(y) then
        return 30
    else
        return 29
    end
...
function isl_to_fixed(month, day, year)
    ...
    return (isl_day_number(month, day, year) + (year - 1) * 354 + math.modf(year / 30) * 11 + ly_in_cycle +
               (IslEpoch - 1))
end
...
function isl_from_fixed(d)
    ...
    y = approx
    while d >= isl_to_fixed(1, 1, y + 1) do
        year = year + 1
        y = y + 1
    end
    month = 1
    m = 1
    while d > isl_to_fixed(m, isl_last_day(m, year), year) do
        month = month + 1
        m = m + 1
    end
...
function ddy2jd(y, ddy, dtp)
    ...
    return 1721424.5 + (y - 1) * 365 + math.modf((y - 1) / 4) - math.modf((y - 1) / 100) + math.modf((y - 1) / 400) +
               ddy + dtp
end
...
function isna_asr(jd, alat, alon, t)
    ...
    A = 1 / 15 *
            math.deg(
            math.acos((math.sin(math.atan(1 / (t + tand(alat - var_s_decl)))) - sind(alat) * sind(var_s_decl)) /
                          (cosd(alat) * cosd(var_s_decl))))
    return A / 24
end
...
function var_qibla(lat, lon)
    return math.atan2(math.sin((klon - lon) * DEGREES) * math.cos(klat * DEGREES),
        math.cos(lat * DEGREES) * math.sin(klat * DEGREES) - math.sin(lat * DEGREES) * math.cos(klat * DEGREES) *
            math.cos((klon - lon) * DEGREES)) / DEGREES
end
...
function on_millisecond(dt)
    ...
    -- 0.02
    var_s_wait =
        (((var_s_fajr - {dtp})) > 0 and var_s_fajr - {dtp} or ((var_s_noon - {dtp})) > 0 and var_s_noon - {dtp} or
            ((var_s_asr - {dtp})) > 0 and var_s_asr - {dtp} or ((var_s_maghrib - {dtp})) > 0 and var_s_maghrib - {dtp} or
            ((var_s_isha - {dtp})) > 0 and var_s_isha - {dtp} or 1 - {dtp})
...
function on_minute(m)
    if var_s_wait >= hm * 119 and var_s_wait <= hm * 121 or var_s_wait >= hm * 59 and var_s_wait <= hm * 61 then
        -- wm_sfx('beep478')
        -- wm_sfx('beep147')
        -- wm_sfx('cool426')
        wm_sfx('casio955')
...
function on_hour(h)
    -- Day of hijri date --
    var_hijri_day = ({dn} < (3) and
                        (((math.floor(365.25 * (({dyy} - 1) + 4716))) + (math.floor(30.6001 * (({dn} + 12) + 1))) + {dd} +
                            2 - (math.floor(({dyy} - 1) / 100)) + (math.floor((math.floor(({dyy} - 1) / 100)) / 4)) -
                            1524 - 1948084) - 10631 *
                            (math.floor(
                ((math.floor(365.25 * (({dyy} - 1) + 4716))) + (math.floor(30.6001 * (({dn} + 12) + 1))) + {dd} + 2 -
                    (math.floor(({dyy} - 1) / 100)) + (math.floor((math.floor(({dyy} - 1) / 100)) / 4)) - 1524 - 1948084) /
                    10631)) -
                            math.floor(
                math.floor(
                    (((math.floor(365.25 * (({dyy} - 1) + 4716))) + (math.floor(30.6001 * (({dn} + 12) + 1))) + {dd} + 2 -
                        (math.floor(({dyy} - 1) / 100)) + (math.floor((math.floor(({dyy} - 1) / 100)) / 4)) - 1524 -
                        1948084) - 10631 *
                        math.floor(
                            ((math.floor(365.25 * (({dyy} - 1) + 4716))) + (math.floor(30.6001 * (({dn} + 12) + 1))) +
                                {dd} + 2 - (math.floor(({dyy} - 1) / 100)) +
                                (math.floor((math.floor(({dyy} - 1) / 100)) / 4)) - 1524 - 1948084) / 10631) - 8.01 /
                        60.) / (10631. / 30.)) * (10631. / 30.) + 8.01 / 60.) - math.floor((math.floor(
            (((math.floor(365.25 * (({dyy} - 1) + 4716))) + (math.floor(30.6001 * (({dn} + 12) + 1))) + {dd} + 2 -
                (math.floor(({dyy} - 1) / 100)) + (math.floor((math.floor(({dyy} - 1) / 100)) / 4)) - 1524 - 1948084) -
                10631 *
                (math.floor(
                    ((math.floor(365.25 * (({dyy} - 1) + 4716))) + (math.floor(30.6001 * (({dn} + 12) + 1))) + {dd} + 2 -
                        (math.floor(({dyy} - 1) / 100)) + (math.floor((math.floor(({dyy} - 1) / 100)) / 4)) - 1524 -
                        1948084) / 10631)) - (math.floor((math.floor(
                (((math.floor(365.25 * (({dyy} - 1) + 4716))) + (math.floor(30.6001 * (({dn} + 12) + 1))) + {dd} + 2 -
                    (math.floor(({dyy} - 1) / 100)) + (math.floor((math.floor(({dyy} - 1) / 100)) / 4)) - 1524 - 1948084) -
                    10631 *
                    (math.floor(
                        ((math.floor(365.25 * (({dyy} - 1) + 4716))) + (math.floor(30.6001 * (({dn} + 12) + 1))) + {dd} +
                            2 - (math.floor(({dyy} - 1) / 100)) + (math.floor((math.floor(({dyy} - 1) / 100)) / 4)) -
                            1524 - 1948084) / 10631)) - 8.01 / 60) / (10631 / 30))) * (10631 / 30) + 8.01 / 60)) +
                28.5001) / 29.5)) * 29.5001 - 29)) or
                        (((math.floor(365.25 * ({dyy} + 4716))) + (math.floor(30.6001 * ({dn} + 1))) + {dd} + 2 -
                            (math.floor({dyy} / 100)) + (math.floor((math.floor({dyy} / 100)) / 4)) - 1524 - 1948084) -
                            10631 *
                            math.floor(
                ((math.floor(365.25 * ({dyy} + 4716))) + (math.floor(30.6001 * ({dn} + 1))) + {dd} + 2 -
                    (math.floor({dyy} / 100)) + (math.floor((math.floor({dyy} / 100)) / 4)) - 1524 - 1948084) / 10631) -
                            math.floor(
                math.floor((((math.floor(365.25 * ({dyy} + 4716))) + (math.floor(30.6001 * ({dn} + 1))) + {dd} + 2 -
                               (math.floor({dyy} / 100)) + (math.floor((math.floor({dyy} / 100)) / 4)) - 1524 - 1948084) -
                               10631 *
                               math.floor(
                        ((math.floor(365.25 * ({dyy} + 4716))) + (math.floor(30.6001 * ({dn} + 1))) + {dd} + 2 -
                            (math.floor({dyy} / 100)) + (math.floor((math.floor({dyy} / 100)) / 4)) - 1524 - 1948084) /
                            10631) - 8.01 / 60.) / (10631. / 30.)) * (10631. / 30.) + 8.01 / 60.) -
                            math.floor(
                (math.floor((((math.floor(365.25 * ({dyy} + 4716))) + (math.floor(30.6001 * ({dn} + 1))) + {dd} + 2 -
                                (math.floor({dyy} / 100)) + (math.floor((math.floor({dyy} / 100)) / 4)) - 1524 - 1948084) -
                                10631 *
                        ...
                        (math.floor(
                            (((math.floor(365.25 * ({dyy} + 4716))) + (math.floor(30.6001 * ({dn} + 1))) + {dd} + 2 -
                                ...
                                10631 *
                                (math.floor(
                                    ((math.floor(365.25 * ({dyy} + 4716))) + (math.floor(30.6001 * ({dn} + 1))) + {dd} +
                                        2 - (math.floor({dyy} / 100)) + (math.floor((math.floor({dyy} / 100)) / 4)) -
                                        1524 - 1948084) / 10631)) - 8.01 / 60) / (10631 / 30))) * (10631 / 30) + 8.01 /
                            60)) + 28.5001) / 29.5)) * 29.5001 - 29)))

    -- Month of hijri date --
    var_hijri_month = (({dn} < (3) and
                          (math.floor(
            (((math.floor(365.25 * (({dyy} - 1) + 4716))) + (math.floor(30.6001 * (({dn} + 12) + 1))) + {dd} + 2 -
                (math.floor(({dyy} - 1) / 100)) + (math.floor((math.floor(({dyy} - 1) / 100)) / 4)) - 1524 - 1948084) -
                10631 *
                ...
                (math.floor(
                    (math.floor(
                        (((math.floor(365.25 * ({dyy} + 4716))) + (math.floor(30.6001 * ({dn} + 1))) + {dd} + 2 -
                            ...
                            (math.floor(
                                ((math.floor(365.25 * ({dyy} + 4716))) + (math.floor(30.6001 * ({dn} + 1))) + {dd} + 2 -
                                    (math.floor({dyy} / 100)) + (math.floor((math.floor({dyy} / 100)) / 4)) - 1524 -
                                    1948084) / 10631)) - 8.01 / 60) / (10631 / 30))) * (10631 / 30) + 8.01 / 60)) +
                28.5001) / 29.5)) == 1) and 01 or ({dn} < (3) and
                          (math.floor(
            (((math.floor(365.25 * (({dyy} - 1) + 4716))) + (math.floor(30.6001 * (({dn} + 12) + 1))) + {dd} + 2 -
                (math.floor(({dyy} - 1) / 100)) + (math.floor((math.floor(({dyy} - 1) / 100)) / 4)) - 1524 - 1948084) -
                10631 *
                        ...
                        (((math.floor(365.25 * ({dyy} + 4716))) + (math.floor(30.6001 * ({dn} + 1))) + {dd} + 2 -
                            ...
                            (math.floor(
                                ((math.floor(365.25 * ({dyy} + 4716))) + (math.floor(30.6001 * ({dn} + 1))) + {dd} + 2 -
                                    (math.floor({dyy} / 100)) + (math.floor((math.floor({dyy} / 100)) / 4)) - 1524 -
                                    1948084) / 10631)) - 8.01 / 60) / (10631 / 30))) * (10631 / 30) + 8.01 / 60)) +
                28.5001) / 29.5)) == 2) and 02 or ({dn} < (3) and
                          (math.floor(
            (((math.floor(365.25 * (({dyy} - 1) + 4716))) + (math.floor(30.6001 * (({dn} + 12) + 1))) + {dd} + 2 -
                (math.floor(({dyy} - 1) / 100)) + (math.floor((math.floor(({dyy} - 1) / 100)) / 4)) - 1524 - 1948084) -
                10631 *
                        ...
                        (((math.floor(365.25 * ({dyy} + 4716))) + (math.floor(30.6001 * ({dn} + 1))) + {dd} + 2 -
                            ...
                            (math.floor(
                                ((math.floor(365.25 * ({dyy} + 4716))) + (math.floor(30.6001 * ({dn} + 1))) + {dd} + 2 -
                                    (math.floor({dyy} / 100)) + (math.floor((math.floor({dyy} / 100)) / 4)) - 1524 -
                                    1948084) / 10631)) - 8.01 / 60) / (10631 / 30))) * (10631 / 30) + 8.01 / 60)) +
                28.5001) / 29.5)) == 3) and 03 or ({dn} < (3) and
                          (math.floor(
            (((math.floor(365.25 * (({dyy} - 1) + 4716))) + (math.floor(30.6001 * (({dn} + 12) + 1))) + {dd} + 2 -
                (math.floor(({dyy} - 1) / 100)) + (math.floor((math.floor(({dyy} - 1) / 100)) / 4)) - 1524 - 1948084) -
                10631 *
                        ...
                        (((math.floor(365.25 * ({dyy} + 4716))) + (math.floor(30.6001 * ({dn} + 1))) + {dd} + 2 -
                            ...
                            (math.floor(
                                ((math.floor(365.25 * ({dyy} + 4716))) + (math.floor(30.6001 * ({dn} + 1))) + {dd} + 2 -
                                    (math.floor({dyy} / 100)) + (math.floor((math.floor({dyy} / 100)) / 4)) - 1524 -
                                    1948084) / 10631)) - 8.01 / 60) / (10631 / 30))) * (10631 / 30) + 8.01 / 60)) +
                28.5001) / 29.5)) == 4) and 04 or ({dn} < (3) and
                          (math.floor(
            (((math.floor(365.25 * (({dyy} - 1) + 4716))) + (math.floor(30.6001 * (({dn} + 12) + 1))) + {dd} + 2 -
                (math.floor(({dyy} - 1) / 100)) + (math.floor((math.floor(({dyy} - 1) / 100)) / 4)) - 1524 - 1948084) -
                10631 *
                        ...
                        (((math.floor(365.25 * ({dyy} + 4716))) + (math.floor(30.6001 * ({dn} + 1))) + {dd} + 2 -
                            ...
                            (math.floor(
                                ((math.floor(365.25 * ({dyy} + 4716))) + (math.floor(30.6001 * ({dn} + 1))) + {dd} + 2 -
                                    (math.floor({dyy} / 100)) + (math.floor((math.floor({dyy} / 100)) / 4)) - 1524 -
                                    1948084) / 10631)) - 8.01 / 60) / (10631 / 30))) * (10631 / 30) + 8.01 / 60)) +
                28.5001) / 29.5)) == 5) and 05 or ({dn} < (3) and
                          (math.floor(
            (((math.floor(365.25 * (({dyy} - 1) + 4716))) + (math.floor(30.6001 * (({dn} + 12) + 1))) + {dd} + 2 -
                (math.floor(({dyy} - 1) / 100)) + (math.floor((math.floor(({dyy} - 1) / 100)) / 4)) - 1524 - 1948084) -
                10631 *
                        ...
                        (((math.floor(365.25 * ({dyy} + 4716))) + (math.floor(30.6001 * ({dn} + 1))) + {dd} + 2 -
                            ...
                            (math.floor(
                                ((math.floor(365.25 * ({dyy} + 4716))) + (math.floor(30.6001 * ({dn} + 1))) + {dd} + 2 -
                                    (math.floor({dyy} / 100)) + (math.floor((math.floor({dyy} / 100)) / 4)) - 1524 -
                                    1948084) / 10631)) - 8.01 / 60) / (10631 / 30))) * (10631 / 30) + 8.01 / 60)) +
                28.5001) / 29.5)) == 6) and 06 or ({dn} < (3) and
                          (math.floor(
            (((math.floor(365.25 * (({dyy} - 1) + 4716))) + (math.floor(30.6001 * (({dn} + 12) + 1))) + {dd} + 2 -
                (math.floor(({dyy} - 1) / 100)) + (math.floor((math.floor(({dyy} - 1) / 100)) / 4)) - 1524 - 1948084) -
                10631 *
                        ...
                        (((math.floor(365.25 * ({dyy} + 4716))) + (math.floor(30.6001 * ({dn} + 1))) + {dd} + 2 -
                            ...
                            (math.floor(
                                ((math.floor(365.25 * ({dyy} + 4716))) + (math.floor(30.6001 * ({dn} + 1))) + {dd} + 2 -
                                    (math.floor({dyy} / 100)) + (math.floor((math.floor({dyy} / 100)) / 4)) - 1524 -
                                    1948084) / 10631)) - 8.01 / 60) / (10631 / 30))) * (10631 / 30) + 8.01 / 60)) +
                28.5001) / 29.5)) == 7) and 07 or ({dn} < (3) and
                          (math.floor(
            (((math.floor(365.25 * (({dyy} - 1) + 4716))) + (math.floor(30.6001 * (({dn} + 12) + 1))) + {dd} + 2 -
                (math.floor(({dyy} - 1) / 100)) + (math.floor((math.floor(({dyy} - 1) / 100)) / 4)) - 1524 - 1948084) -
                10631 *
                        ...
                        (((math.floor(365.25 * ({dyy} + 4716))) + (math.floor(30.6001 * ({dn} + 1))) + {dd} + 2 -
                            ...
                            (math.floor(
                                ((math.floor(365.25 * ({dyy} + 4716))) + (math.floor(30.6001 * ({dn} + 1))) + {dd} + 2 -
                                    (math.floor({dyy} / 100)) + (math.floor((math.floor({dyy} / 100)) / 4)) - 1524 -
                                    1948084) / 10631)) - 8.01 / 60) / (10631 / 30))) * (10631 / 30) + 8.01 / 60)) +
                28.5001) / 29.5)) == 8) and 08 or ({dn} < (3) and
                          (math.floor(
            (((math.floor(365.25 * (({dyy} - 1) + 4716))) + (math.floor(30.6001 * (({dn} + 12) + 1))) + {dd} + 2 -
                (math.floor(({dyy} - 1) / 100)) + (math.floor((math.floor(({dyy} - 1) / 100)) / 4)) - 1524 - 1948084) -
                10631 *
                        ...
                        (((math.floor(365.25 * ({dyy} + 4716))) + (math.floor(30.6001 * ({dn} + 1))) + {dd} + 2 -
                            ...
                            (math.floor(
                                ((math.floor(365.25 * ({dyy} + 4716))) + (math.floor(30.6001 * ({dn} + 1))) + {dd} + 2 -
                                    (math.floor({dyy} / 100)) + (math.floor((math.floor({dyy} / 100)) / 4)) - 1524 -
                                    1948084) / 10631)) - 8.01 / 60) / (10631 / 30))) * (10631 / 30) + 8.01 / 60)) +
                28.5001) / 29.5)) == 9) and 09 or ({dn} < (3) and
                          (math.floor(
            (((math.floor(365.25 * (({dyy} - 1) + 4716))) + (math.floor(30.6001 * (({dn} + 12) + 1))) + {dd} + 2 -
                (math.floor(({dyy} - 1) / 100)) + (math.floor((math.floor(({dyy} - 1) / 100)) / 4)) - 1524 - 1948084) -
                10631 *
                        ...
                        (((math.floor(365.25 * ({dyy} + 4716))) + (math.floor(30.6001 * ({dn} + 1))) + {dd} + 2 -
                            ...
                            (math.floor(
                                ((math.floor(365.25 * ({dyy} + 4716))) + (math.floor(30.6001 * ({dn} + 1))) + {dd} + 2 -
                                    (math.floor({dyy} / 100)) + (math.floor((math.floor({dyy} / 100)) / 4)) - 1524 -
                                    1948084) / 10631)) - 8.01 / 60) / (10631 / 30))) * (10631 / 30) + 8.01 / 60)) +
                28.5001) / 29.5)) == 10) and 10 or ({dn} < (3) and
                          (math.floor(
            (((math.floor(365.25 * (({dyy} - 1) + 4716))) + (math.floor(30.6001 * (({dn} + 12) + 1))) + {dd} + 2 -
                (math.floor(({dyy} - 1) / 100)) + (math.floor((math.floor(({dyy} - 1) / 100)) / 4)) - 1524 - 1948084) -
                10631 *
                        ...
                        (((math.floor(365.25 * ({dyy} + 4716))) + (math.floor(30.6001 * ({dn} + 1))) + {dd} + 2 -
                            ...
                            (math.floor(
                                ((math.floor(365.25 * ({dyy} + 4716))) + (math.floor(30.6001 * ({dn} + 1))) + {dd} + 2 -
                                    (math.floor({dyy} / 100)) + (math.floor((math.floor({dyy} / 100)) / 4)) - 1524 -
                                    1948084) / 10631)) - 8.01 / 60) / (10631 / 30))) * (10631 / 30) + 8.01 / 60)) +
                28.5001) / 29.5)) == 11) and 11 or 12)

    -- Year of hijri date --
    var_hijri_year = ({dn} < (3) and
                         (30 *
                             math.floor(
                ((math.floor(365.25 * (({dyy} - 1) + 4716)) + math.floor(30.6001 * (({dn} + 12) + 1)) + ({dd}) + 2 -
                    math.floor(({dyy} - 1) / 100) + math.floor(math.floor(({dyy} - 1) / 100) / 4) - 1524) - 1948084) /
                ...
                ((math.floor(365.25 * (({dyy} - 1) + 4716)) + math.floor(30.6001 * (({dn} + 12) + 1)) + ({dd}) + 2 -
                    ...
                    math.floor(
                        ((math.floor(365.25 * (({dyy} - 1) + 4716)) + math.floor(30.6001 * (({dn} + 12) + 1)) + ({dd}) +
                            2 - math.floor(({dyy} - 1) / 100) + math.floor(math.floor(({dyy} - 1) / 100) / 4) - 1524) -
                            1948084) / 10631) - (8.01 / 60)) / (10631 / 30))) or
                         (30 *
                             math.floor(
                ((math.floor(365.25 * ({dyy} + 4716)) + math.floor(30.6001 * ({dn} + 1)) + ({dd}) + 2 -
                    math.floor({dyy} / 100) + math.floor(math.floor({dyy} / 100) / 4) - 1524) - 1948084) / 10631) +
